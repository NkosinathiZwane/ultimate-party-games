...
const ThisOrThat = () => {
  ...
  const getRandomQuestion = () => {
    const availableQuestions = gameContent.thisOrThat.filter(
    ...
    if (availableQuestions.length === 0) {
      ...
      setUsedQuestions([]);
      return gameContent.thisOrThat[Math.floor(Math.random() * gameContent.thisOrThat.length)];
    }
  ...
  return (
    <div className="game-screen">
      ...
      <div className="game-header">
        ...
        <p>Make your choice and spark some debates!</p>
      </div>
      ...
      <div style={{ 
        ...
        {usedQuestions.length > 0 && (
          <p>Remaining questions: <strong>{gameContent.thisOrThat.length - usedQuestions.length}</strong></p>
        )}
      </div>
